...
from bikinghub.constants import LINK_RELATIONS_URL, MASON
...
def entry_point():
    body = BodyBuilder()
    body.add_namespace("bhub", LINK_RELATIONS_URL)
    body.add_control_users_all()
    body.add_control("bhub:locations-all", href="/api/locations/")
    body.add_control("bhub:weather-all", href="/api/weather/")
